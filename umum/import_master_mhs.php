...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="91%"><font color="#006699"><font color="#0099CC" size="1"><strong>SETTING ~</strong> IMPORT MASTER MAHASISWA</font></font> </td>
...
<form method="post" action="import_master_mhs.php?imp=1" enctype="multipart/form-data">
