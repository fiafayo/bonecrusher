...
/* 
   ...
   KEGUNAAN     : ENTRY MASTER RUANG TAMBAH
...
// validasi form
	...
	if (($frm_kode_ruang=='') or ($frm_nama_ruang=='') or ($frm_kapasitas=='')) 
		{
			$error = 1;
	...
	if ($error !=1) // Jika semua isian form valid 
		...
		//echo "<br>ID KOTA=".$frm_id_kota;
			...
			if ($frm_kode_ruang=='')  
				{
					$result = mysql_query("INSERT INTO master_ruang (`id`, `kode`, `nama`, `tipe`, `kapasitas`, `luas`, `LCD`, `komputer`, `mic`, `speaker`) VALUES( NULL, '".$frm_kode_ruang."', '".$frm_nama_ruang."', '".$frm_jenis_ruang."', ".$frm_kapasitas.", NULL, '".$frm_LCD."', '".$frm_komputer."', '".$frm_mic."', '".$frm_speaker."')");
					if ($result) 
						{
			...
			else
				{
					...
					$result = mysql_query("UPDATE master_ruang SET  master_ruang.kode='$frm_kode_ruang',
															  ...
															  WHERE master_ruang.id=$frm_id_data");
					if ($result) 
						{
...
$result = mysql_query("delete from master_ruang where id = $frm_id_data");
...
// jika user mengisi nama kota, check apakah nama kota sudah ada, kalau sudah ada maka data akan ditampilkan
	if ($frm_kode_ruang!='')  {
			$result = mysql_query("SELECT master_ruang.id,
										  master_ruang.kode,
										  master_ruang.nama,
										  master_ruang.tipe,
									...
									FROM  master_ruang 
									WHERE master_ruang.kode='$frm_kode_ruang'");
...
<body class="body">
<form name="frm_master_ruang" id="frm_master_ruang" action="umum_master_ruang_add.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      <td colspan="4"><hr size="1" color="#FF9900">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="91%"><font color="#006699"><font color="#0099CC" size="1"><strong>ENTRY DATA ~</strong> MASTER RUANG</font></font> </td>
    ...
    <tr>
      ...
      <td width="15%">&nbsp;</td>
      <td width="2%">&nbsp;</td>
      <td width="83%"><input type="hidden" name="frm_id_data" id="frm_id_data" value="<?php echo $frm_id_data; ?>"> </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Kode Ruang </td>
      <td><strong>:</strong></td>
      <td><input name="frm_kode_ruang" type="text" class="tekboxku" id="frm_kode_ruang" onBlur="document.frm_master_ruang.submit()" value="<?php echo $frm_kode_ruang; ?>" size="12" maxlength="10" >
	...
	<tr>
	  ...
	  <td>Projector</td>
	  <td><strong>:</strong></td>
	  <td><select name="frm_projector" id="frm_projector" class="tekboxku">
	...
	<tr>
	  ...
	  <td>Computer</td>
	  <td><strong>:</strong></td>
	  <td><select name="frm_computer" id="frm_computer" class="tekboxku">
	...
	<tr>
	  ...
	  <td>Microphone</td>
	  <td><strong>:</strong></td>
	  <td><select name="frm_mic" id="frm_mic" class="tekboxku">
	...
	<tr>
	  ...
	  <td>Speaker</td>
	  <td><strong>:</strong></td>
	  <td><select name="frm_speaker" id="frm_speaker" class="tekboxku">
	...
	<tr>
	  ...
	  <td>
        ...
        <?php if ($frm_kode_ruang) { ?>
        <input name="Submit3" type="button" class="tombol"  onClick="if(confirm('Hapus ?')){this.form.action+='?act=2&id=<?php echo $frm_kode_ruang;?>';this.form.submit()};" value="Hapus">
        <?php } ?>
	  </td>
    </tr>
    <tr> 
