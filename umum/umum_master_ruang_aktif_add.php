...
echo "<br>frm_id_tahun_ajar=".$frm_id_tahun_ajar;
	if (($frm_s_jurusan=='pilih') or ($frm_angkatan=='') or ($frm_id_tahun_ajar=='') or ($frm_kapasitas=='')) 
		{
			$error = 1;
	...
	if ($error !=1) // Jika semua isian form valid 
		...
		//echo "<br>ID KOTA=".$frm_id_kota;
			if ($frm_id_kota=='')  
				{
					$result = mysql_query("INSERT INTO mhs_aktif (`idnya`, `id_jurusan`, `angkatan`, `jum_mhs`, `periode`) VALUES( NULL, ".$frm_s_jurusan.", '".$frm_angkatan."', ".$frm_kapasitas.", ".$frm_id_tahun_ajar.")");
					if ($result) 
						{
...
<form name="umum_mhs_aktif" id="umum_mhs_aktif" action="umum_mhs_aktif_add.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td>Kode Ruang </td>
      <td><strong>:</strong></td>
      <td><input name="frm_kode_ruang" type="text" class="tekboxku" id="frm_kode_ruang" value="<?php echo $frm_kode_ruang; ?>" size="12" maxlength="10" >
</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_nama_ruang" type="text" class="tekboxku" id="frm_nama_ruang" value="<?php echo $frm_nama_ruang; ?>" size="60" maxlength="254" ></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
