...
// Kode dan nama harus diisi
	...
	{
		//echo "<br>TULISAN";
		if (($frm_kode_dsn1=='') or ($frm_s_jurusan=='') or ($frm_ska_publikasi=='') or ($frm_tipe_publikasi=='') or ($frm_judul=='') or ($frm_jenis_pen=="0")) 
		{
			$error = 1;
			$jum=0;
			$pesan=$pesan."Maaf, Anda harus memilih Jenis Penelitian serta mengisi Dosen, Status jabatan dan Judul. Gagal menyimpan data."; 
		}
	}
...
<SCRIPT language=Javascript>
	  ...
	  $(document).ready(function(){
		  $("#frm_tgl_publikasi").datepicker({
			dateFormat:"dd/mm/yy",
			//showOn: 'button',
			//buttonText: '...'  
		  });
		  
		  $("#frm_tgl_terbit").datepicker({
			dateFormat:"dd/mm/yy",
			//showOn: 'button',
			//buttonText: '...'  
		  });
		  
		  $("#frm_tgl_mulai").datepicker({
			dateFormat:"dd/mm/yy",
			//showOn: 'button',
			//buttonText: '...'  
		  });
		  
		   $("#frm_tgl_selesai").datepicker({
			dateFormat:"dd/mm/yy",
			//showOn: 'button',
			//buttonText: '...'  
		  });
			...
			//$("#Submit4").button();
			$("#Submit1,#Submit2,#Submit3,#Submit4").button();
...
<form name="penelitian" id="penelitian" action="penelitian_dosen_entry.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      <td>&nbsp;</td>
      <td nowrap>No. Surat Tugas Penelitian Terakhir</td>
      <td><strong>:</strong></td>
      <td>
	  <?
	  	$sql="SELECT kode_pen 
    ...
    <tr>
      <td>&nbsp;</td>
      <td nowrap>No. Surat Tugas penelitian Sekarang</td>
      <td><strong>:</strong></td>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_tgl_publikasi" type="text" class="tekboxku" id="frm_tgl_publikasi" value="<?php echo $frm_tgl_publikasi; ?>" size="10" maxlength="10">(dd/mm/yyyy)</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_tgl_terbit" type="text" class="tekboxku" id="frm_tgl_terbit" value="<?php echo $frm_tgl_terbit; ?>" size="10" maxlength="10">(dd/mm/yyyy)  
	  </td>
    </tr>
	<? }?>
	...
	<tr>
      ...
      <td>Tanggal Mulai</td>
      <td><strong>:</strong></td>
      <td><input name="frm_tgl_mulai" type="text" class="tekboxku" id="frm_tgl_mulai" value="<?php echo $frm_tgl_mulai; ?>" size="10" maxlength="10">(dd/mm/yyyy)</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td nowrap>Tanggal Selesai</td>
      <td><strong>:</strong></td>
      <td><input name="frm_tgl_selesai" type="text" class="tekboxku" id="frm_tgl_selesai" value="<?php echo $frm_tgl_selesai; ?>" size="10" maxlength="10">(dd/mm/yyyy)</td>
    </tr>
	...
	<tr>
      ...
      <td>
	   <select name="frm_id_sumber_dana" id="frm_id_sumber_dana" class="tekboxku">
	        <option <?php if ($frm_id_sumber_dana==''){echo "selected";}?> value="0">--- Pilih ---</option>
			<?php
    ...
    <tr>
	  ...
	  <? //echo "frm_id_pen=".$frm_id_pen;?>
	    <input name="Submit4" type="submit" id="Submit4" onClick="this.form.action+='?act=1&jum=<? echo $jum;?>';this.form.submit();" value="Simpan" class="ui-icon-disk">
        <input type="reset" name="Submit2" id="Submit2" value="Batal" onClick="this.form.action+='?act=3';this.form.submit();">
        <?php if ($frm_id_pen) { ?>
        <input type="button" name="Submit3" id="Submit3" value="Hapus"  onClick="if(confirm('Hapus ?')){this.form.action+='?act=2&id=<?php echo $frm_id;?>';this.form.submit()};">
        <input type="submit" name="submit1" id="submit1" value="PRINT" onClick="cetak();">
		<?php } ?>
	  </td>
    </tr>
    <tr> 
