...
/* 
   ...
   KEGUNAAN: MENAMPILKAN LAPORAN PROFIL KERJASAMA
*/
...
<hr size="1" color="#FF9900">
<form name="form_lap_kerjasama" id="form_lap_kerjasama">
  <table width="100%" class="body">
    ...
    <tr>
      ...
      <td width="70%"><input name="frm_s_tanggal_mulai1" type="text" class="tekboxku" id="frm_s_tanggal_mulai1" value="<?php echo $sekarang; ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('form_lap_kerjasama.frm_s_tanggal_mulai1',0,0,'DD/MM/YYYY')"> <img src="../img/date.png" width="22" height="22" align="absbottom" border=0></A> -
        ...
        <A Href="javascript:show_calendar('form_lap_kerjasama.frm_s_tanggal_mulai2',0,0,'DD/MM/YYYY')"> <img src="../img/date.png" width="22" height="22" align="absbottom" border=0> </A>(dd/mm/yyyy)</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      ...
      <td>
        ...
        <A Href="javascript:show_calendar('form_lap_kerjasama.frm_s_tanggal_selesai1',0,0,'DD/MM/YYYY')"> <img src="../img/date.png" width="22" height="22" align="absbottom" border=0></A> -
        ...
        <A Href="javascript:show_calendar('form_lap_kerjasama.frm_s_tanggal_selesai2',0,0,'DD/MM/YYYY')"> <img src="../img/date.png" width="22" height="22" align="absbottom" border=0> </A>(dd/mm/yyyy)</td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      <td>Jurusan</td>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><select name="frm_tipe_kerjasama" id="frm_tipe_kerjasama" class="tekboxku">
        <option value="all">Semua
        <?
			
			$sql2="select * from tipe_kerjasama";
    ...
    <tr>
      ...
      <td> <select name="frm_s_sumber_dana" id="frm_s_sumber_dana" class="tekboxku">
          ...
          <?
			...
			$sql2="select * from sumber_dana ORDER BY id ASC";
			if(!($result2=mysql_db_query($DB,$sql2)))
			{
				echo mysql_error();
        			return 0;
    ...
    <tr>
      ...
      <td>
		  <select name="frm_s_publikasi" id="frm_s_publikasi" class="tekboxku">
            <option value="all">Semua
            <?
				$sql2="select * from jenis_kerjasama ORDER BY id ASC";
				if(!($result2=mysql_db_query($DB,$sql2)))
				{
					echo mysql_error();
						return 0;
...
/*$sql="SELECT profil_kerjasama.id,
			 ...
			 profil_kerjasama.jabatan,
			 profil_kerjasama.judul,
			 DATE_FORMAT(profil_kerjasama.mulai,\"%d/%m/%Y\") as tanggal_terbit,
			 DATE_FORMAT(profil_kerjasama.selesai,\"%d/%m/%Y\") as tanggal_mulai,
			 profil_kerjasama.jumlah_staff,
			 profil_kerjasama.id_sumber_dana,
			 profil_kerjasama.jumlah_dana,
			 profil_kerjasama.up_date,
	  ...
	  LEFT JOIN dosen ON profil_kerjasama.kode_dosen = dosen.kode
	  LEFT JOIN jurusan ON profil_kerjasama.jurusan = jurusan.jurusan";			
			*/
...
// PROSES UNTUK SEARCH (MODE=2)
	...
	//{ $sql=$sql." and profil_kerjasama.jenis_pen = ".$frm_s_jenis_pen; } 
	//if ($frm_s_sifat_pen!="all")
	//{ $sql=$sql." and profil_kerjasama.man_kel = '".$frm_s_sifat_pen."'"; } 
	//if ($frm_s_publikasi!="all")
	//{ $sql=$sql." and profil_kerjasama.publikasi = ".$frm_s_publikasi; } 
...
$vlink="lap_profil_kerjasama.php";
...
$abc="?mode=2&frm_s_tanggal_mulai1=$frm_s_tanggal_mulai1&frm_s_tanggal_mulai2=$frm_s_tanggal_mulai2&frm_s_tanggal_selesai1=$frm_s_tanggal_selesai1&frm_s_tanggal_selesai2=$frm_s_tanggal_selesai2&frm_s_jurusan=$frm_s_jurusan&frm_s_kode=$frm_s_kode&frm_s_judul=$frm_s_judul&frm_s_sumber_dana=$frm_s_sumber_dana&frm_s_publikasi=$frm_s_publikasi&frm_s_jum_data=$frm_s_jum_data";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> PROFIL KERJASAMA</font></font> </td>
    <td width="11%" nowrap bgcolor="#0099CC"><div align="center"><strong><font color="#FFFFFF">DOSEN</font></strong></div></td>
  </tr>
</table>
<hr size="1" color="#FF9900">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=lap_profil_kerjasama.php class=menu_left>:: Kembali</a>";
...
{
?>
<FORM METHOD="Post" name="fexcel" id="fexcel" ACTION="lap_profil_kerjasama_export.php">
...
<input type="hidden" name="frm_tipe_kerjasama" value="<?php echo $frm_tipe_kerjasama; ?>">
...
?>
		<tr>
			...
			<td nowrap align="right" valign="top">
				Edit <input name="edit" onClick="document.fexcel.action='profil_kerjasama_entry.php?frm_id=<?php echo $row["id"];?>&frm_kode=<?php echo $row["kode"];?>'"   type="image" src="../img/edit.png" width="16" height="16"><br>
				Hapus <input name="hapus"  onclick="if(confirm('Hapus ?')){this.form.action='profil_kerjasama_entry.php?act=2&frm_id=<?php echo $row["id"];?>';this.form.submit()} else{return false};" type="image" src="../img/hapus.png" width="11" height="13"> 
			</td>
			<? }?>
...
?><tr>
		<td colspan=15>
			<input name="excel" type="image" onClick="document.fexcel.action='lap_profil_kerjasama_export.php?t=excel'" src="../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
			Export ke File Excel
			<input name="printer" type="image"  onClick="document.fexcel.action='lap_profil_kerjasama_export.php?t=printer'" src="../img/print.gif" align="bottom" width="18" height="18"> 
			Print
		</td>
	</tr>
</table>
