<?
/* 
   KETERANGAN 	: EXPORT LAPORAN PENGABDIAN MASYARAKAT
...
$sql="SELECT pengabdian.id,
	  ...
	  /* WHERE dosen.kode=pengabdian.kode_dosen AND 
	         pengabdian.id_sumber_dana=sumber_dana.id AND
			 pengabdian.jurusan=jurusan.id AND
			 pengabdian.id_jenis=jenis_kerjasama.id";		*/
...
$excel_export.="<b>LAPORAN PENGABDIAN MASYARAKAT</b><br>";
...
header("Content-Disposition: attachment; filename=pengabdian-".date("dmY").".xls");
