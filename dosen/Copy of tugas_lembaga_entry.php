...
if ($frm_kode_tgs_lembaga!=''){
echo "<br>kode=".$frm_kode_tgs_lembaga;
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td><?
		...
		$frm_kode_tgs_lembaga_tgs_lembaga = $row_kode_terakhir["kode"];
		$frm_no_legal_lama = $row_kode_terakhir["no_legalitas"];
	  ?>
        <input name="frm_kode_tgs_lembaga_tgs_lembaga" type="text" onBlur="document.form_tugas_lembaga.submit()" class="tekboxku" id="frm_kode_tgs_lembaga_tgs_lembaga" value="<?php echo $frm_kode_tgs_lembaga_tgs_lembaga; ?>" size="15" maxlength="10">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_no_legal_lama" type="text" class="tekboxku" id="frm_no_legal_lama"  value="<?php echo $frm_no_legal_lama; ?>" size="15" maxlength="10" readonly="true" >
