<?php
/* 
   DATE CREATED : 11/12/05- RAHADI
   UPDATE  		: 
   PROBLEM 		:
   KEGUNAAN     : Mencari Dosen Penelitian Ilmiah
   VARIABEL     :  
*/
...
-->
  ...
  <table width="100%" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td> 
	  <form name="frmCariDosen"  method="post" action="pen_tulisan_ilmiah_cari_dsn.php?action=go">
	  ...
	  <table width="98%" border="1" cellpadding="2" cellspacing="0" bordercolor="#0099CC">
        ...
        <script language="JavaScript">
			function konfirmasi(id_ds)
			{
				...
				if (say)
				{
					opener.location.href = 'pen_tulisan_ilmiah_entry.php?frm_id_karyawan='+id_ds;
					window.close();
				}
			}
		</script>
