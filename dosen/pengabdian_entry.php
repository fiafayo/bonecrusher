...
// Kode dan nama harus diisi  
	...
	if ($error !=1) // Jika semua isian form valid 
		...
		echo "<br>frm_no_legal_now=".$frm_no_legal_now;
		...
		echo "<br>frm_id_tipe=".$frm_id_tipe ;
		echo "<br>frm_judul=".$frm_judul;
		echo "<br>frm_mulai=".$frm_mulai ;
		echo "<br>frm_kode_dsn1=".$frm_kode_dsn;
		echo "<br>frm_status_jabatan1=".$frm_status_jabatan ;
		echo "<br>frm_selesai=".$frm_selesai;
		echo "<br>frm_tempat=".$frm_tempat ;
		echo "<br>frm_jumlah_staff=".$frm_jumlah_staff;
		echo "<br>frm_id_sumber_dana=".$frm_id_sumber_dana ;
		echo "<br>frm_jumlah_dana=".$frm_jumlah_dana;
		echo "<br>jum dosen=".$jum;
		echo "<br>frm_sifat_pen=".$frm_sifat_pen;
		
			if (($frm_id=='') or (!isset($frm_id)))
				{ //frm_jumlah_staff
					echo "<br>____> HERE=".$act;
					for ($i = 1; $i <= $jum; $i++) {
						$kd_dsn="frm_kode_dsn".$i;
						$status_jbtn="frm_status_jabatan".$i;
						echo "<br>!!!!!!frm_kode_dsn=".$frm_kode_dsn1;
						echo "<br>!!!!!!status_jbtn=".$frm_status_jabatan1;
			...
			else
				{
					//echo "<br>frm_mulai=".$frm_mulai;
					//echo "<br>frm_selesai=".$frm_selesai;
					//echo "<br>JUM_STAFF=".$frm_jumlah_staff;
					$i=1;
					//frm_jumlah_staff
					while($i <= $jum)
					{
					//for ($i = 1; $i <= $frm_jumlah_staff; $i++) {
						$kd_dsn="frm_kode_dsn".$i;
						$status_jbtn="frm_status_jabatan".$i;
						echo "<br>$kd_dsn UPDATE=".$$kd_dsn;
						echo "<br>$status_jbtn UPDATE=".$$status_jbtn;
						
					
					//exit();
					            $sql_ubah="UPDATE pengabdian SET `no_legalitas` = '$frm_no_legal_now',
					                                             `jurusan` = $frm_jurusan, 
														   ...
														   WHERE `kode` = '$frm_kode' AND `kode_dosen` = '".$$kd_dsn."'";
					echo "<br>sql_ubah= ".$sql_ubah;
					$result = mysql_query($sql_ubah);
						...
						echo $frm_jumlah_dana;
									...
									$res_dsn = mysql_query( " SELECT  pengabdian.id,
										...
										while($row_dsn = mysql_fetch_array($res_dsn))
										{
											...
											$$frm_status_jabatan=$row_dsn["jabatan"];
											$a++;
										}
									}
					}
