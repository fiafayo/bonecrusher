...
// BEGIN UBAH TABEL #########################################################################################################					
					...
					{
							$result_1_2 = mysql_query("INSERT INTO publikasi ( `no_legalitas` , `no_st_pub` , `urut_st_pub` , `jenis`, `publikasi`, `tgl_publikasi`, `jurn_pros`, 
																			   `kode_kary`, `kode_kary2`, `kode_kary3`, `kode_kary4`, `kode_kary5`, `status` , `TET_sub` , `TNET_sub` , 
																			   `judul`, `tugas` , `hari_go` , `tgl_go` , `pukul_go` , `tempat_go` , `transport_go` , 
																			   `hari_dtg` , `tgl_dtg` , `pukul_dtg` , `transport_dtg` , `biaya` , 
																			   `L_ap_tax` , `L_fiskal` , `L_visa` , `L_saku` , `L_akomo` , `L_other` , `ndt_terakhir`) 
														  VALUES ( '".$frm_no_legalitas_now."', '".$frm_no_st_pub_now."', NULL, ".$frm_jenis.", '".$frm_ska_publikasi."', '".$frm_tgl_publikasi."', '".$frm_tipe_publikasi."', 
														           '".$frm_kode_dsn1."', '".$frm_kode_dsn2."', '".$frm_kode_dsn3."', '".$frm_kode_dsn4."', 
																   '".$frm_kode_dsn5."', '".$frm_status."', '".$frm_TET."', '".$frm_TNET."', 
																   '".$frm_judul."', '".$frm_tugas."', '".$frm_hari_go."','".$frm_tgl_go."', '".$frm_pukul_go."', 
...
$result = mysql_query("Select publikasi.no_legalitas,
					     ...
					     FROM publikasi
					LEFT JOIN penelitian 
					       ON publikasi.no_st_pub = penelitian.kode_pen
					    WHERE publikasi.no_st_pub='".$frm_no_st_pub_now."'");
