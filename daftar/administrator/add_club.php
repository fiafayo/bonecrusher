	...
	if ($error !=1) // Jika semua isian form valid 
		...
		// data id tidak ada, berarti record baru
			if (($frm_exist!=1) AND ($frm_no_ID_club==""))
				{
					echo"inset";
					$result = mysql_query("INSERT INTO club (nama, alamat, kota_club, propinsi_club)VALUES('".$frm_nama."','".$frm_alamat."',".$frm_kota.", ".$frm_propinsi.")" );
  				    if ($result) 
						{
...
<table width="90%" border="1">
  ...
  <tr>
    <td>
    <form id="form_club" name="form_club" action="index.php?menu=addClub" method="post">
