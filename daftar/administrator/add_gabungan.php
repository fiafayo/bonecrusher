...
// NRP dan NAMA harus diisi
	if (($frm_nama=='') or ($frm_alamat=='') or ($frm_kota=='') or ($frm_propinsi=='')) 
		{
			$error = 1;
	...
	if ($error !=1) // Jika semua isian form valid 
		...
		// data id tidak ada, berarti record baru
			if (($frm_exist!=1) AND ($frm_no_ID_club==""))
				{
					$result = mysql_query("INSERT INTO gabungan (nama, alamat, kota_gabungan, propinsi_gabungan)VALUES('".$frm_nama."','".$frm_alamat."',".$frm_kota.", ".$frm_propinsi.")" );
  				    if ($result) 
						{
...
<table width="90%" border="1">
  ...
  <tr>
    <td>
    <form id="form_gabungan" name="form_gabungan" action="index.php?menu=addGab" method="post">
