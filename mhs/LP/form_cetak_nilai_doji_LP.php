...
<html>
<head>
<title>: : CETAK NILAI DOSEN PENGUJI 1 : :</title>
...
/*echo "<br>var_no_ST=".$var_no_ST;
echo "<br>var_periode=".$var_periode;
echo "<br>var_thn_ajar=".$var_thn_ajar;*/


$sql_nilai_doji_1="SELECT DATE_FORMAT(`daftar_uji_lp`.`TGLUJI`,'%d/%m/%Y') as TGL_UJI,
						  daftar_uji_lp.`RUANG`,
      ...
      <tr>
        <td><table width="98%"  border="1" align="center" cellpadding="5" cellspacing="0">
          <tr>
            ...
            <td width="29%" rowspan="2"><div align="center" class="style1"><strong>ITEM PENELITIAN </strong></div></td>
            <td width="34%"><div align="center" class="style1"><strong>NILAI (N)</strong></div></td>
            <td width="34%"><div align="center" class="style1"><strong>NILAI (N)</strong></div></td>
          </tr>
          <tr>
			  <? 
			  $sql_nilai_mhs_doji_1="SELECT  master_mhs.NRP,
			  								 master_mhs.NAMA
										FROM  master_mhs, no_surat_lp
										WHERE master_mhs.NRP =  no_surat_lp.NRP AND
											  no_surat_lp.N_ST = '".$var_no_ST."'";
						  
			 $result3 = mysql_query($sql_nilai_mhs_doji_1);
			  while($row3 = mysql_fetch_array($result3))
				{
				/* $frm_nrp = $row3["NRP"];
				$frm_nama = $row3["NAMA"];
				$frm_ruang = $row3["RUANG"];
				$frm_judul_LP = $row3["JUDUL1"];
				$frm_kodobing_1 = $row3["PEMBIMBING_1"];
				$frm_kodobing_2 = $row3["PEMBIMBING_2"];
				$frm_kodoji_1 = $row3["PENGUJI_1"];
				$frm_kodoji_2 = $row3["PENGUJI_2"];
				//echo "<br>frm_kodoji_1".$frm_kodoji_1;
				//echo "<br>frm_kodoji_2".$frm_kodoji_2;
				
				$frm_tgl_uji_LP =$row3["TGL_UJI"];
				if ($row3["TGL_UJI"]=="00/00/0000") {
				$frm_tgl_uji_LP = ""; }else {
				$frm_tgl_uji_LP = $row3["TGL_UJI"];}*/
			  ?>
