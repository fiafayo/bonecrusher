...
$frm_doji1= ( isset( $_REQUEST['frm_doji1'] ) ) ? $_REQUEST['frm_doji1'] : null;
$frm_doji2= ( isset( $_REQUEST['frm_doji2'] ) ) ? $_REQUEST['frm_doji2'] : null;
$frm_dobing1= ( isset( $_REQUEST['frm_dobing1'] ) ) ? $_REQUEST['frm_dobing1'] : null;
$frm_dobing2= ( isset( $_REQUEST['frm_dobing2'] ) ) ? $_REQUEST['frm_dobing2'] : null;
$frm_ruang_ujian= ( isset( $_REQUEST['frm_ruang_ujian'] ) ) ? $_REQUEST['frm_ruang_ujian'] : null;
 

 
$frm_judul_LP= ( isset( $_REQUEST['frm_judul_LP'] ) ) ? $_REQUEST['frm_judul_LP'] : null;
$frm_no_SK_LP_now= ( isset( $_REQUEST['frm_no_SK_LP_now'] ) ) ? $_REQUEST['frm_no_SK_LP_now'] : null;
$frm_no_SK_LP_terakhir= ( isset( $_REQUEST['frm_no_SK_LP_terakhir'] ) ) ? $_REQUEST['frm_no_SK_LP_terakhir'] : null;
$frm_no_ST_LP_now= ( isset( $_REQUEST['frm_no_ST_LP_now'] ) ) ? $_REQUEST['frm_no_ST_LP_now'] : null;

$frm_exist= ( isset( $_REQUEST['frm_exist'] ) ) ? $_REQUEST['frm_exist'] : null;
$frm_exist3= ( isset( $_REQUEST['frm_exist3'] ) ) ? $_REQUEST['frm_exist3'] : null;
			...
			if ($frm_exist!=1) 
			...
			else
				{
					...
					$result_cek_NRP = mysql_query("SELECT `daftar_uji_lp`.`PEMBIMBING_1`
                                        ...
                                        $row_cek_NRP = mysql_fetch_array($result_cek_NRP);
					if ($row_cek_NRP) 
					{
					...
					//if ($result) 
						//{
							$result_no_surat_LP_now = mysql_query("SELECT `no_surat_lp`.`N_SK`,
                                                        ...
                                                        $row_no_surat_LP_now = mysql_fetch_array($result_no_surat_LP_now);
								if ($row_no_surat_LP_now) 
								{
					...
					if ($row) {
						...
						$frm_ruang_ujian = $row["RUANG"];
								...
								$result_no_SK_LP_now = mysql_query("SELECT `no_surat_lp`.`N_ST`,
                                                                ...
                                                                $row_no_SK_LP_now = mysql_fetch_array($result_no_SK_LP_now);
								if ($row_no_SK_LP_now) {
									$frm_exist=1;
