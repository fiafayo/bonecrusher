...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN LAPORAN MAHASISWA YG SEDANG LP
*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA YANG SEDANG LP</font></font></td>
    <td width="11%" bgcolor="#0099CC"><div align="center"><strong><font color="#FFFFFF">MAHASISWA</font></strong></div></td>
  </tr>
</table>
<hr size="1" color="#FF9900">
<form name="lap_sedang_lp" id="lap_sedang_lp">
  <table align="center" class="body" >
    ...
    <tr> 
      ...
      <td><input name="frm_tgl_periode" type="text" class="tekboxku" id="frm_tgl_periode" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('lap_sedang_lp.frm_tgl_periode',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>&nbsp;&nbsp;&nbsp;&nbsp;s/d&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="frm_tgl_periode2" type="text" class="tekboxku" id="frm_tgl_periode2" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('lap_sedang_lp.frm_tgl_periode2',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>(dd/mm/yyyy) </td>
    </tr>
    <tr>
...
$vlink="mhs_lap_informasi_mhs_sedang_LP.php";
...
{
?>
<FORM METHOD="Post" name="fexcel" id="fexcel" ACTION="mhs_lap_informasi_mhs_sedang_LP.php">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=mhs_lap_informasi_mhs_sedang_LP.php class=menu_left>:: Kembali</a>";
...
?>
	  <table width="100%"  border="1" cellspacing="0" cellpadding="5" class="table">
		  <tr bgcolor="#C6E2FF">
			...
			<th nowrap><strong>Batas akhir LP</strong></th>
		  </tr>
<?
$a=0;
...
?>
   ...
   <input name="excel"   type="image" onClick="document.fexcel.action='mhs_lap_informasi_mhs_sedang_LP_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
   Export ke File Excel &nbsp;
    <input name="printer"  onClick="document.fexcel.action='mhs_lap_informasi_mhs_sedang_LP_export.php?t=printer'" type="image" src="../../img/print.gif" width="18" height="18"> 
    Print
</FORM>
<?
}
