...
$tanggal_akhir = ( isset( $_REQUEST['tanggal_akhir'] ) ) ? $_REQUEST['tanggal_akhir'] : null;
	...
	if ($error !=1) // Jika semua isian form valid 
		{
					...
					if ($row2) 
					{
						$result_update_tgl_akhir_ta= mysql_query("UPDATE master_lp set `TGL_MULAI`='$frm_tgl_surat_dibuat', `TGL_SELESAI`='$tanggal_akhir' where `NRP`=$frm_nrp");
...
<html>
<head>
<meta http-equiv="Refresh" content="60; URL=mhs_cetak_ST_LP.php">
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>CETAK 
              ~</strong> SURAT TUGAS PENELITIAN</font></font></td>
