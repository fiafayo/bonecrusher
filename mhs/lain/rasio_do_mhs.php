			...
			if ($frm_exist!=1) 
				{
					...
					echo "<br>jum_mhs_aktif=".$frm_jum_mhs_do;
			...
			else
				{
					...
					echo "<br>frm_jurusan=".$frm_jurusan;
					echo "<br>jum_mhs_aktif=".$frm_jum_mhs_aktif;
					echo "<br>jum_mhs_do=".$frm_jum_mhs_do;
...
$result = mysql_query("DELETE FROM do WHERE id_do = ".$frm_id_do);
...
<form name="form_do" id="form_do" action="rasio_do_mhs.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td width="1%">&nbsp;</td>
      <td width="79%">
		  <input type="hidden" name="frm_id_do" id="frm_id_do" value="<?php echo $frm_id_do;?>">
...
<font color="#FF0000">*</font>	  </td>
    ...
    <tr>
      ...
      <td> <font color="#FF0000">
        <input name="frm_angkatan" id="frm_angkatan" onBlur="document.form_do.submit()" value="<? echo $frm_angkatan;?>" type="text" class="tekboxku" size="10" maxlength="10" >
      *</font></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>
		...
		<?php if ($frm_id_do) { ?>
		<input name="Submit3" type="button" class="tombol"  onClick="if(confirm('Hapus ?')){this.form.action+='?act=2&frm_id_do=<?php echo $frm_id_do;?>';this.form.submit()};" value="Hapus">
		<?php } ?>
	  </td>
    </tr>
    <tr> 
