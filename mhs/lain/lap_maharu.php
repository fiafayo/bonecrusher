...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN LAPORAN MAHASISWA BARU
*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA BARU </font></font></td>
    <td width="11%" bgcolor="#0099CC"><div align="center"><strong><font color="#FFFFFF">MAHASISWA</font></strong></div></td>
  </tr>
</table>
<hr size="1" color="#FF9900">
<form name="lap_maharu" id="lap_maharu">
...
{
?>
<FORM METHOD="Post" name="fexcel" id="fexcel" ACTION="lap_maharu_export.php">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=lap_maharu.php class=menu_left>:: Kembali</a>";
...
?>
		<table width="100%"  border="1" cellspacing="0" cellpadding="5" class="table">
		  <tr bgcolor="#C6E2FF">
			...
			<td nowrap><strong>Jumlah Mhs</strong></td>
			<td nowrap><strong>Tgl. Masuk</strong></td>
		  </tr>
<?
$a=0;
...
?>
          <tr> 
            ...
            <td nowrap><? echo $row["jum_mhs"]; ?></td>
            <td nowrap><? echo $row["tgl_masuk"]; ?></td>
          </tr>
<?
}
?>
        </table>
	<input name="excel"   type="image" onClick="document.fexcel.action='lap_maharu_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
	Export ke File Excel &nbsp;
	<input name="printer"  onClick="document.fexcel.action='lap_maharu_export.php?t=printer'" type="image" src="../../img/print.gif" width="18" height="18"> 
	Print
</FORM>
<?
}
