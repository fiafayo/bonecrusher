...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN LAPORAN MAHASISWA PO
*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA PO</font></font></td>
    <td width="11%" bgcolor="#0099CC"><div align="center"><strong><font color="#FFFFFF">MAHASISWA</font></strong></div></td>
  </tr>
</table>
<hr size="1" color="#FF9900">
<form name="form_mhs_po" id="form_mhs_po">
...
$sql="SELECT po.id_po,
			 ...
			 po.semester
        FROM po,jurusan
	   WHERE po.jurusan_id=jurusan.id";
...
// PROSES UNTUK SEARCH (MODE=2)
	...
	{ 
		$sql .= " and po.jurusan_id='".$frm_s_jurusan."'";
	}
	if ($frm_angkatan!="")
	{ 
		$sql .= " and po.angkatan='".$frm_angkatan."'";
	}
...
{
?>
<FORM METHOD="Post" name="fexcel" id="fexcel" ACTION="lap_mhs_po_export.php">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=lap_mhs_po.php class=menu_left>:: Kembali</a>";
...
?>
		<table width="100%"  border="1" cellspacing="0" cellpadding="5" class="table">
		  <tr bgcolor="#C6E2FF">
			...
			<td nowrap><strong>Jumlah Mhs PO</strong></td>
		  </tr>
<?
$a=0;
...
?>
          <tr> 
            ...
            <td nowrap><? echo $row["jum_mhs_PO"]; ?></td>
          </tr>
<?
}
?>
        </table>
	<input name="excel"   type="image" onClick="document.fexcel.action='lap_mhs_po_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
	Export ke File Excel &nbsp;
	<input name="printer"  onClick="document.fexcel.action='lap_mhs_po_export.php?t=printer'" type="image" src="../../img/print.gif" width="18" height="18"> 
	Print
</FORM>
<?
}
