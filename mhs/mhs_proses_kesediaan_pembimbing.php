...
$result = mysql_query("Select nama, 
							  ...
							  sex, 
							  tempat_lahir, 
							  DATE_FORMAT(tanggal_lahir,'%d/%m/%Y') as tanggal_lahir, email, telepon_asal, telepon_sekarang, hp, nama_ortu, alamat_ortu, zip_ortu, telepon_ortu, id_kota_ortu, DATE_FORMAT(tanggal_keluar,'%d/%m/%Y') as tanggal_keluar, id_smu, usm, id_status from master_mhs 
							  where nrp='$frm_nrp'");
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>ENTRY 
              DATA ~</strong> PROSES KESEDIAAN PEMBIMBING</font></font></td>
