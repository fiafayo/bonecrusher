...
<form name="mhs" action="mhs_1_8.php" method=post>
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>ENTRY 
              DATA ~</strong> PROSES GANTI PEMBIMBING TA </font></font> </td>
    ...
    <tr>
      ...
      <td><input name="frm_nama" type="text" class="tekboxku" id="frm_nama" value="<?php echo $frm_nama; ?>" size="30" maxlength="50">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td nowrap>Kode Dosen Lama </td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_kode_dosen_lama" id="frm_kode_dosen_lama" type="text" class="tekboxku" value="<?php echo $frm_kode_dosen_lama; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Kode Dosen Baru </td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_kode_dosen_baru" id="frm_kode_dosen_baru" type="text" class="tekboxku" value="<?php echo $frm_kode_dosen_baru; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_setuju" id="frm_setuju" type="text" class="tekboxku" value="<?php echo $frm_setuju; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
