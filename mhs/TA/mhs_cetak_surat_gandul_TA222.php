...
/* 
   ...
   KEGUNAAN     : CETAK SURAT GANTI JUDUL TA
	...
	if ($error !=1) // Jika semua isian form valid 
		{
					...
					if ($row = mysql_fetch_array($result)) 
					{
						...
						$row_result_cek = mysql_num_rows($result_cek);
								...
								if ($row_result_cek >= 1) // N_GANDUL SUDAH ADA
								{
									if ($row_urut_gandul["N_urut_gandul"]<>0)
									{
										$result_update1 = mysql_query("UPDATE no_surat set `N_GANDUL`='$frm_no_surat_gandul_baru' WHERE `NRP`='$frm_nrp'");
										//$result_update1 = mysql_query("UPDATE no_surat SET `N_GANDUL`='$frm_no_surat_gandul_baru' WHERE `NRP`='$frm_nrp'");
									}
									else
									{
									...
									//$result_update2 = mysql_query("UPDATE ganti_judul set `NO_GANTI`='$frm_no_surat_gandul_baru' WHERE `NRP`='$frm_nrp'");
									if ($result_update1)
									{
											?>
											<script language="JavaScript">
													newwindow=window.open('form_cetak_gandul_TA.php?nrp=<? echo $frm_nrp;?>&no_gandul_TA=<? echo $frm_no_surat_gandul_baru;?>','name','top=0,left=510,scrollbars=yes');
					...
					$error = 1;
					$pesan = $pesan."<br>Mahasiswa belum pernah mengajukan TA. Gagal mencetak data.". mysql_error();
...
$result = mysql_query("SELECT master_mhs.NRP,
					   ...
					   WHERE `master_mhs`.`NRP` =  '".$frm_nrp."'");
							...
							{$frm_exist=0; header("Location: mhs_cetak_surat_gandul_ta.php"); }		
}
...
<html>
<head>
<meta http-equiv="Refresh" content="120; URL=mhs_cetak_surat_gandul_TA.php">
...
<body class="body">
<form name="mhs" id="mhs" action="mhs_cetak_surat_gandul_ta.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>CETAK 
              ~</strong> SURAT GANTI JUDUL TA</font></font></td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td nowrap>No. surat ganti judul TA terakhir</td>
      <td width="1%"><strong>:</strong></td>
      <td><input name="frm_no_surat_gandul_terakhir" type="text" class="tekboxku" id="frm_no_surat_gandul_terakhir" onBlur="document.mhs.submit()" value="<?php echo $frm_no_surat_gandul_terakhir; ?>" size="10" maxlength="10" > 
        <span class="style1">*</span></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>No. surat ganti judul TA</td>
      <td><strong>:</strong></td>
      <td><input name="frm_no_surat_gandul_baru" type="text" class="tekboxku" id="frm_no_surat_gandul_baru" value="<?php echo $frm_no_surat_gandul_baru; ?>" size="10" maxlength="10" >
      <span class="style1">*</span></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
