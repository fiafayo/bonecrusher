...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN DOSEN PEMBIMBING LUAR YG AKTIF PER PERIODE
...
{
	if(theForm.frm_s_jurusan.value=='pilih')
	{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA BIMBINGAN DOSEND LUAR YANG AKTIF PER PERIODE </font></font></td>
    <td width="11%" bgcolor="#0099CC"><div align="center"><strong><font color="#FFFFFF">MAHASISWA</font></strong></div></td>
  </tr>
</table>
<hr size="1" color="#FF9900">
<form  name="lap_dobing_luar" id="lap_dobing_luar">
  <table width="80%" align="center" class="body" >
    ...
    <tr>
      ...
      <td><input name="frm_tgl_periode" type="text" class="tekboxku" id="frm_tgl_periode" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('lap_dobing_luar.frm_tgl_periode',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>&nbsp;&nbsp;&nbsp;&nbsp;s/d&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="frm_tgl_periode2" type="text" class="tekboxku" id="frm_tgl_periode2" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('lap_dobing_luar.frm_tgl_periode2',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>(dd/mm/yyyy) </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td><input type="submit" value="Proses" onClick="return Form(this);" class="tombol"></td>
    </tr>
  </table>
</form>
<?
...
$vlink="mhs_lap_daftar_dobing_luar_yang_aktif.php";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> </font></font><font size="1"><span class="style2">DAFTAR MAHASISWA BIMBINGAN DOSEN LUAR YANG AKTIF PER PERIODE </span></font>	   </td>
...
{
?>
<FORM METHOD="Post" name="fexcel" ACTION="mhs_lap_daftar_dobing_luar_yang_aktif.php">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=mhs_lap_daftar_dobing_luar_yang_aktif.php class=menu_left>:: Kembali</a>";
		...
		<table width="100%"  border="1" cellspacing="0" cellpadding="3" class="table">
            <tr bgcolor="#C6E2FF">
					...
					<td nowrap><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="24%" nowrap><strong>Tgl</strong></td>
				  ...
				  <tr valign="top">
					...
					<? // if ($a==1) 
					   ...
					   $sql_total_bim_1="SELECT master_ta.NRP,
									   ...
									   WHERE (master_ta.NRP=master_mhs.NRP) AND (KODOS1='".$row_1["kode_dosen_temp"]."' OR KODOS2='".$row_1["kode_dosen_temp"]."') AND (master_ta.KOLUS=''AND master_ta.STATUS='')";
										if($frm_tgl_periode!="" && $frm_tgl_periode2!="")
										{ 
...
<tr><td>
   ...
   <input name="excel"   type="image" onClick="document.fexcel.action='mhs_lap_daftar_dobing_luar_yang_aktif_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
   Export ke File Excel&nbsp;
    <input name="printer" type="image"  onClick="document.fexcel.action='mhs_lap_daftar_dobing_luar_yang_aktif_export.php?t=printer'" src="../../img/print.gif" align="bottom" width="18" height="18"> 
    Print
