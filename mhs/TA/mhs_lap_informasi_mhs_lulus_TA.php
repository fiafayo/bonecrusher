...
/* 
   ...
   LAST UPDATE  : 26/07/07 - RAHADI
                  22/11/08 - RAHADI tambah field tgl.lulus ta, tgl.lulus s1, ipk, sks
   KEGUNAAN     : MENAMPILKAN LAPORAN MAHASISWA YG LULUS TA
*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA YANG LULUS S1 </font></font></td>
...
$vlink="mhs_lap_informasi_mhs_lulus_TA.php";
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=mhs_lap_informasi_mhs_lulus_TA.php class=menu_left>:: Kembali</a>";
              ...
              <? 
					switch ($row["jurusan"])
					{
						...
						case '6F':
							...
							break;
						case '6G':
							echo "Program Kekhususan DMP";
							break;
						case '6H':
							echo "Program Kekhususan Sistem Informasi";
							break;
						case '6I':
							echo "Program Kekhususan Multimedia";
							break;
					}
				?>
            </td>
...
?>
	...
	<input name="excel"   type="image" onClick="document.fexcel.action='mhs_lap_informasi_mhs_lulus_TA_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
	Export ke File Excel &nbsp;
	<input name="printer"  onClick="document.fexcel.action='mhs_lap_informasi_mhs_lulus_TA_export.php?t=printer'" type="image" src="../../img/print.gif" width="18" height="18"> 
	Print
</FORM>
<?
}
