...
<form name="mhs" action="mhs_1_8.php" method=post>
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>CETAK 
              ~</strong> MEMO UNTUK PEMBAYARAN</font></font></td>
    ...
    <tr> 
      ...
      <td width="17%">&nbsp;</td>
      <td width="1%">&nbsp;</td>
      <td width="72%"><input name="frm_exist" type="hidden" id="frm_exist"  value="<?php echo $frm_exist; ?>" ></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>Ujian TA ke</td>
      <td><strong>:</strong></td>
      <td><input name="frm_nrp2" type="text" class="tekboxku" id="frm_nrp2" onBlur="document.mhs.submit()" value="<?php echo $frm_nrp; ?>" size="10" maxlength="10" ></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td>Tanggal memo dibuat</td>
      <td><strong>:</strong></td>
