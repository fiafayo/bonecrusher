...
$result = mysql_query("SELECT	master_mhs.NRP,
							...
							{$frm_exist=0; header("Location: mhs_cetak_sk_lulus_s1_new.php"); }		
...
<html>
<head>
<meta http-equiv="Refresh" content="60; URL=mhs_cetak_sk_lulus_s1_new.php">
...
<body class="body"> 
<form name="mhs" id="mhs" action="mhs_cetak_sk_lulus_s1_new.php" method="post"> 
