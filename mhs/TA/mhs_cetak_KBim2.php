...
/* 
   ...
   KEGUNAAN     : CETAK KARTU BIMBINGAN UNTUK DOSEN PEMBIMBING 2
	...
	if ($error !=1) // Jika semua isian form valid 
		{
					...
					if ($row = mysql_fetch_array($result)) 
					{
						...
						<script language="JavaScript">
							...
							//{
								newwindow=window.open('form_cetak_kartu_bim2.php?nrp=<? echo $frm_nrp;?>','name','top=0,left=510,scrollbars=yes');
...
{
// jika user mengisi NRP, maka di cek apakah data NRP sudah ada, kalau sudah ada maka nama akan ditampilkan
if ($frm_nrp!='')  {
$result = mysql_query("SELECT  master_mhs.NRP,
	...
	{$frm_exist=0; header("Location: mhs_cetak_KBim2.php"); }
	}
}
...
<body class="body">
<form name="mhs" id="mhs" action="mhs_cetak_KBim2.php" method="post">
      ...
      <td colspan="4"> <hr size="1" color="#FF9900"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>CETAK 
              ~</strong> KARTU BIMBINGAN 2</font></font></td>
