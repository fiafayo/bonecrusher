<?php
/* 
   DATE CREATED : 06/06/10
   KEGUNAAN     : EXPORT KELULUSAN KE EXCEL (NRP, THN LULUS, SEMESTER LULUS, NO.SK, TGL.SK, KONSENTRASI)
   VARIABEL     : 
...
if ($frm_id_tahun_ajar !='all')
{
	$excel_export.="<div align=\"center\"><b>FAKULTAS TEKNIK - UNIVERSITAS SURABAYA</b></div>
					<div align=\"center\"><b>EXPORT KELULUSAN MAHASISWA</b></div>
...
$excel_export.="<tr>
					...
					<td nowrap>".$row_1["tahun"]."</td>
					<td nowrap>".$row_1["semester"]."</td>
					<td nowrap>".$row_1["N_SK_LULUS"]."</td>
...
header("Content-Disposition: attachment; filename=Export_Kelulusan_MHS-".date("dmY").".xls");
