<?php
/* 
   DATE CREATED : 07/06/10
   LAST UPDATE  : 
   KEGUNAAN     : EXPORT SKRIPSI ke EXCEL (NRP, JUDUL SKRIPSI, TGL.MULAI, TGL.SELESAI NPK DP1, NPK DP2)
*/
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#006699"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> EXPORT SKRIPSI MAHASISWA</font></font></td>
...
// PROSES UNTUK SEARCH (MODE=2)
	...
	/*switch($frm_urutkan)
	{
		...
		case "judul" :
			$sql=$sql." order by master_ta.JUDUL_TA ASC";
		break;
	...
	//$sql=$sql." order by master_ta.AKHIR1 ";
...
{
?>
<FORM METHOD="Post" name="fexcel" id="fexcel" ACTION="mhs_lap_skripsi_export.php">
...
if (mysql_num_rows($result)==0) {
	...
	echo "<br><br><a href=mhs_lap_skripsi.php class=menu_left>:: Kembali</a>";
...
?>
		<table width="100%"  border="1" cellspacing="0" cellpadding="5" class="table">
		  <tr bgcolor="#C6E2FF">
			...
			<td nowrap><strong>Tgl. Mulai </strong></td>
			<td nowrap><strong>Tgl. Selesai </strong></td>
			<td nowrap><strong>NPK Dosen Pembimbing 1</strong></td>
			<td nowrap><strong>NPK Dosen Pembimbing 2</strong></td>
		  </tr>
<?
$a=0;
...
?>
	...
	<input name="excel"  type="image" onClick="document.fexcel.action='mhs_lap_skripsi_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
	Export ke File Excel &nbsp;
	<input name="printer"  onClick="document.fexcel.action='mhs_lap_skripsi_export.php?t=printer'" type="image" src="../../img/print.gif" width="18" height="18"> 
	Print
</FORM>
<?
}
