...
/* 
   ...
   KEGUNAAN     : FORM CETAK KARTU BIMBINGAN UNTUK DOSEN PEMBIMBING 1
...
<html>
<head>
<title>: : CETAK KARTU BIMBINGAN 1 : :</title>
...
<table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="100%"  border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td><table width="80%"  border="0" align="center" cellpadding="10" cellspacing="0">
          ...
          <tr>
            <td nowrap>6.</td>
            <td nowrap><? //Tanggal mengajukan Tugas Akhir?>Tanggal Surat Tugas Akhir </td>
            <td><strong>:</strong></td>
            <td>
              <?php 
  ...
  <tr>
    <td><table width="40%"  border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>(<u><? echo $var_nama_dobing_1;?></u>)</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
