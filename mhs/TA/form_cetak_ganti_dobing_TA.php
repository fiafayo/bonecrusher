...
<html>
<head>
<title>: : CETAK GANTI DOSEN PEMBIMBING TA : :</title>
...
$result = mysql_query("SELECT   master_mhs.NRP,
								...
								no_surat.N_gandos
					   FROM
								master_mhs, ganti_dobing, master_ta, no_surat
					   WHERE
								master_mhs.NRP =  ganti_dobing.NRP AND
...
<tr><td>&nbsp;</td></tr>
  <tr>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td>Perihal</td>
        <td><strong>:</strong></td>
        <td>Pindah Dosen Pembimbing Tugas Akhir</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td><table width="85%"  border="0" align="center" cellpadding="5" cellspacing="0">
      ...
      <tr>
        <td><div align="justify">Membalas surat Saudara/i tertanggal <? echo $var_tgl_aju; ?> perihal permohonan &quot;PINDAH DOSEN PEMBIMBING TUGAS AKHIR&quot; dan sesuai dengan persetujuan KETUA JURUSAN, maka kami TIDAK KEBERATAN Saudara/i mengganti dosen pembimbing DARI : </div></td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td><table width="70%"  border="0" align="center" cellpadding="5" cellspacing="0">
          <tr>
            <td width="34%" nowrap>DOSEN PEMBIMBING I </td>
            <td width="3%">:</td>
            <td width="6%" nowrap><b><? echo $var_kodobing_1; ?></b></td>
            <td width="57%" nowrap> <? echo $var_nama_kodobing_1; ?></td>
          </tr>
          <tr>
    ...
    <td><table width="90%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="79%"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td width="5%" nowrap><? echo "1. $var_kodobing_1";?></td>
            <td width="95%" nowrap><? echo "- ".$var_nama_kodobing_1;?></td>
          </tr>
          <tr>
