...
/* 
   ...
   UPDATE       : 30/03/2009 - tambah field bidang minat
   			      24/08/2010 - ubah inputan bidang minat -> textbox menjadi combobox
			...
			if ($frm_exist!=1) 
				{
					...
					$result = mysql_query("UPDATE lulus_ta set `sks`='".$frm_sks_kum."', 
															   ...
															   `semester`='".$row_periode->semester."',
															   `tahun`='".$row_periode->tahun_ajaran."',
...
$result = mysql_query("SELECT	master_mhs.NRP,
						...
						{$frm_exist=0; header("Location: mhs_sk_lulus.php"); 
						}
}
}
...
<form name="mhs" id="mhs" action="mhs_sk_lulus.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td>
			  <select name="frm_bidang_minat" id="frm_bidang_minat" class="tekboxku">
				<option <?php if ($frm_bidang_minat==''){echo "selected";}?>>--- Pilih ---</option>
				<?php 
						$sql_minat="SELECT id, 
										   jurusan,
										   minat
    ...
    <tr>
      ...
      <td>Bidang Minat </td>
      <td><strong>:</strong></td>
      <td><input name="frm_bidang_minat" type="text" class="tekboxku" id="frm_bidang_minat" value="<?php echo $frm_bidang_minat; ?>" size="63" maxlength="254" >
      <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
