...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN DOSEN PEMBIMBING LUAR YG AKTIF per DOSEN
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="89%"><font color="#0099CC" size="1"><strong>LAPORAN 
      ~</strong> DAFTAR MAHASISWA BIMBINGAN DOSEN LUAR YANG AKTIF PER DOSEN PEMBIMBING</font></td>
...
$vlink="mhs_lap_daftar_dobing_luar_yang_aktif_dsn.php";
...
{
?>
<FORM METHOD="Post" name="fexcel" ACTION="mhs_lap_daftar_dobing_luar_yang_aktif_dsn.php">
...
<tr><td>
   ...
   <input name="excel"   type="image" onClick="document.fexcel.action='mhs_lap_daftar_dobing_luar_yang_aktif_dsn_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
   Export ke File Excel&nbsp;
    <input name="printer" type="image"  onClick="document.fexcel.action='mhs_lap_daftar_dobing_luar_yang_aktif_dsn_export.php?t=printer'" src="../../img/print.gif" align="bottom" width="18" height="18"> 
    Print
