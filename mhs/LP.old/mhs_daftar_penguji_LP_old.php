...
if ($frm_nrp!='')  {
	...
	$result = mysql_query("  SELECT	master_mhs.NRP,
									...
									`daftar_uji_lp`.`RUANG`,
									`no_surat_lp`.N_SK
						       FROM `master_mhs`, `daftar_uji_lp`, `no_surat_lp` 
						      WHERE (`master_mhs`.`NRP` = `daftar_uji_lp`.`NRP`) AND
									(`daftar_uji_lp`.`NRP` = `no_surat_lp`.`NRP`)  AND
									(`master_mhs`.`NRP` LIKE '6__2%') AND
									(`master_mhs`.`NRP` = '".$frm_nrp."')");  
...
<form name="mhs" id="mhs" action="mhs_daftar_penguji_LP.php" method="post">
  <table width=" 100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_no_ST_LP_mhs" id="frm_no_ST_LP_mhs" type="text" class="tekboxku" value="<?php echo $frm_no_ST_LP_mhs; ?>" size="10" maxlength="10"></td>
    </tr>
    <tr>
      <td nowrap>&nbsp;</td> 
	  ...
	  ?>
	  <input name="frm_no_SK_LP_terakhir" id="frm_no_SK_LP_terakhir" type="text" class="tekboxku" value="<?php echo $frm_no_SK_LP_terakhir; ?>" size="10" maxlength="10">	  </td>
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_no_SK_LP_now" id="frm_no_SK_LP_now" type="text" class="tekboxku" value="<?php echo $frm_no_SK_LP_now; ?>" size="10" maxlength="10">      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
