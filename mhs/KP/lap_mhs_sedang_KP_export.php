...
/* 
   ...
   KEGUNAAN     : EXPORT LAPORAN MAHASISWA SEDANG KP
   VARIABEL     : 
...
$excel_export.="<div align=\"left\"><b>FAKULTAS TEKNIK - UNIVERSITAS SURABAYA</b></div>
				<div align=\"left\"><b>LAPORAN DAFTAR MAHASISWA SEDANG KP</b></div>
				<div align=\"left\"><b>Periode: ".$frm_tgl_periode." - ".$frm_tgl_periode2."</b></div>
				<br><br>";
...
header("Content-Disposition: attachment; filename=LAP_mhs_sedang_KP-".date("dmY").".xls");
