...
/* 
   ...
   KEGUNAAN     : MENAMPILKAN DAFTAR MAHASISWA SELESAI KP
   KETERANGAN   : 
*/
...
<hr size="1" color="#FF9900">
<form name="form_mhs_selesai_kp" id="form_mhs_selesai_kp">
  <table width="100%" align="center" class="body" >
    ...
    <tr>
      ...
      <td><input name="frm_tgl_periode" type="text" class="tekboxku" id="frm_tgl_periode" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('form_mhs_selesai_kp.frm_tgl_periode',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>&nbsp;&nbsp;&nbsp;&nbsp;s/d&nbsp;&nbsp;&nbsp;&nbsp;
        <input name="frm_tgl_periode2" type="text" class="tekboxku" id="frm_tgl_periode2" value="<?php echo date('d/m/Y'); ?>" size="10" maxlength="10">
        <A Href="javascript:show_calendar('form_mhs_selesai_kp.frm_tgl_periode2',0,0,'DD/MM/YYYY')"> <img src="../../img/date.png" width="22" height="22" align="absbottom" border=0> </A>(dd/mm/yyyy) </td>
    </tr>
    <tr>
      <td nowrap>&nbsp;</td>
...
//echo "<br>SQL= ".$sql;
//echo "<br>jur_kode= ".$jur_kode;
//	echo "<br>jur_kode2= ".$jur_kode2;
...
$abc="?mode=2&frm_s_jurusan=$frm_s_jurusan&frm_s_jum_data=$frm_s_jum_data&frm_NRP=$frm_NRP&frm_kode_dobing=$frm_kode_dobing&frm_tgl_periode=$frm_tgl_periode&frm_tgl_periode2=$frm_tgl_periode2";
...
?>
			<tr>
			  <td width="81%" valign="top"><? echo ($hal-1)*$frm_s_jum_data+$a; ?></td>
...
?>
   ...
   <input name="excel"   type="image" onClick="document.fexcel.action='lap_mhs_slesai_KP_export.php?t=excel'" src="../../img/Mexcel.jpg" align="bottom" width="18" height="18"> 
   Export ke File Excel&nbsp;
    <input name="printer" type="image"  onClick="document.fexcel.action='lap_mhs_slesai_KP_export.php?t=printer'" src="../../img/print.gif" align="bottom" width="18" height="18"> 
    Print
</FORM>
<?
}
