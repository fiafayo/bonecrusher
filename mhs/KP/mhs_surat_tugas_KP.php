...
*/
	...
	if (($frm_no_surat_pemohon=='') or ($frm_nrp1=='') or ($frm_tgl_surat_pemohon=='') or ($frm_no_ST_KP_terakhir=='') or ($frm_no_ST_KP=='') or ($frm_tgl_ST_KP=='') or ($frm_kode_dobing=='') or ($frm_bing_persh=='')) 
		{
			$error = 1;
			...
			if ($frm_exist==1) // update tabel daftar_KP untuk ST KP
				{
					...
					if ($result) 
						...
						$sql_cek_NO_ST="SELECT `daftar_kp`.`NO_ST`,`daftar_kp`.`UR_ST`
								          FROM `daftar_kp` 
								         WHERE `daftar_kp`.`NO_MOHON`=".$frm_no_surat_pemohon;
						$result_cek_NO_ST = mysql_query($sql_cek_NO_ST);
						$row_cek_NO_ST = mysql_fetch_array($result_cek_NO_ST);
						if (($row_cek_NO_ST['NO_ST']=='') and ($row_cek_NO_ST['UR_ST']==0))
...
<html>
<head>
<meta http-equiv="Refresh" content="300; URL=mhs_surat_tugas_KP.php">
...
var no_st_filter=/^\d{9}$/

function cek_ST(e){
var returnval=no_st_filter.test(e.value)
if (returnval==false){
alert("Nomor ST harus 9 digit")
e.select()
e.focus()
}
return returnval
...
<DIV id="TipLayer" style="visibility:hidden;position:absolute;z-index:1000;top:-100;"></DIV>
 <SCRIPT language="JavaScript1.2" src="../../include/style.js" type="text/javascript"></SCRIPT> <br>
...
<form name="mhs_ST" id="mhs_ST" action="mhs_surat_tugas_KP.php" method="post">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_no_surat_pemohon" type="text" class="tekboxku" id="frm_no_surat_pemohon" onBlur="document.mhs_ST.submit()" value="<?php echo $frm_no_surat_pemohon; ?>" size="10" maxlength="9" >
    ...
    <tr>
      ...
      <td>NRP 6 </td>
      <td><strong>:</strong></td>
      <td><input name="frm_nrp6" type="text" class="tekboxku" id="frm_nrp6" onBlur="this.form.action+='?sub=nrp6&nilai='+document.mhs_ST.frm_nrp6.value;this.form.submit();" value="<?php echo $frm_nrp6; ?>" size="10" maxlength="10" >
        <span class="style1">
    ...
    <tr>
      ...
      <td>NRP 7 </td>
      <td><strong>:</strong></td>
      <td><input name="frm_nrp7" type="text" class="tekboxku" id="frm_nrp7" onBlur="this.form.action+='?sub=nrp7&nilai='+document.mhs_ST.frm_nrp7.value;this.form.submit();" value="<?php echo $frm_nrp7; ?>" size="10" maxlength="10" >
        <span class="style1">
    ...
    <tr>
      ...
      <td>NRP 8 </td>
      <td><strong>:</strong></td>
      <td><input name="frm_nrp8" type="text" class="tekboxku" id="frm_nrp8" onBlur="this.form.action+='?sub=nrp8&nilai='+document.mhs_ST.frm_nrp8.value;this.form.submit();" value="<?php echo $frm_nrp8; ?>" size="10" maxlength="10" >
        <span class="style1">
    ...
    <tr>
      ...
      <td><strong>:</strong></td>
      <td><input name="frm_no_ST_KP" type="text" onBlur="return cek_ST(this.form.frm_no_ST_KP)" onMouseOver="stm(Text[13],Style[12])" onMouseOut="htm()" class="tekboxku" id="frm_no_ST_KP" value="<?php echo $frm_no_ST_KP; ?>" size="10" maxlength="9" >
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td nowrap>&nbsp;</td> 
      <td nowrap>Kode Dosen Pembimbing</td>
    ...
    <tr>
      ...
      <td><div align="center"><strong>:</strong></div></td> 
      <td><input name="frm_bing_persh" id="frm_bing_persh" type="text" class="tekboxku" value="<?php echo $frm_bing_persh; ?>" size="50" maxlength="100">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
