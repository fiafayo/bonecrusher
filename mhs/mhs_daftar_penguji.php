...
<form name="mhs" action="mhs_1_8.php" method=post>
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="body">
    ...
    <tr>
      ...
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_kode_ketua" id="frm_kode_ketua" type="text" class="tekboxku" value="<?php echo $frm_kode_ketua; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
      ...
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_kode_sekre" id="frm_kode_sekre" type="text" class="tekboxku" value="<?php echo $frm_kode_sekre; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>NPK Dosen 3 </td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_kode_dosen_3" id="frm_kode_dosen_3" type="text" class="tekboxku" value="<?php echo $frm_kode_dosen_3; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td> 
    ...
    <tr>
      ...
      <td>Ruang</td>
      <td><div align="center"><strong>:</strong></div></td>
      <td><input name="frm_ruang_ujian" id="frm_ruang_ujian" type="text" class="tekboxku" value="<?php echo $frm_alamat_asal; ?>" size="10" maxlength="10">
        <span class="style1">*</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
